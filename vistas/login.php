<section class="container" id="login">
    ...
    <form method="POST" action="admin/actions/auth_login.php" class="form row justify-content-center align-items-center p-4">
        <div class="form-group col-7">
            ...
            <input requiredd type="text" name="nombre_usuario" id="nombre_usuario" class="form-control">
        </div>

        <div class="form-group col-7">
            <label class="fw-bold" for="contrasena">Contraseña</label>
            <input requiredd type="password" name="contrasena" id="contrasena" class="form-control">
        </div>
